...
if (isset($_POST['enviar'])) {
    ...
    try {
        ...
        $mail->Username = 'soporte@dangercar.es';    // SMTP username
        $mail->Password = 'Daw_2023';                               // SMTP password
        ...
        //Recipients
        $mail->setFrom('soporte@dangercar.es');   //quien lo envia, en este caso nosotros mismo
